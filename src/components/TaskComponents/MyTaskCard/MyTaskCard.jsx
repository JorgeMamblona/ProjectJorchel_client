...
const MyTaskCard = ({
    ...
    return (
        <div className={`task-data row justify-content-between my-task-${taskState.state} `}>
            ...
            <div className="col-3">
                <div className="colaborators justify-content-around">
                                ...
                                <Form onSubmit={handleFormSubmit}>
                                    <div className="row">
                                        <div className="col-6 item-list">
                                            ...
                                            <Form.Control type="text" value={editFormData.title} name='title' placeholder={title} onChange={handleInputChange}></Form.Control>
                                        </div>
                                        <div className="col-5 ">
                                            <Row>
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            ...
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control type="text" value={editFormData.description} name='description' placeholder={description} onChange={handleInputChange}></Form.Control>
                                            </Form.Group>
                                        </div>
                                    </div>
                                    <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-5 item-list">
                                            ...
                                            <Col >
                                                <Form.Group className="mb-3">
                                                    <Form.Label>Current start date: {prettyDate(startDate)}</Form.Label>
