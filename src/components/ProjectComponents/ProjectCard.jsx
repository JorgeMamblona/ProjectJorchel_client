...
import AvatarListColaborators from '../AvatarList/AvatarListColaborators'
...
const ProjectCard = ({ title, state, endDate, colaborators }) => {
    console.log(title, state, endDate)
    ...
    return (
        <div className={`project-card ${state}`}>
            <div className="header-project-card d-flex justify-content-between">
                ...
                <div className="options d-flex">
                    <Link>
                        <Button className='button-options'>
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.24998 19.7917C6.24998 20.3442 6.46947 20.8741 6.86017 21.2648C7.25087 21.6555 7.78078 21.875 8.33331 21.875H16.6666C17.2192 21.875 17.7491 21.6555 18.1398 21.2648C18.5305 20.8741 18.75 20.3442 18.75 19.7917V7.29167H6.24998V19.7917ZM8.33331 9.375H16.6666V19.7917H8.33331V9.375ZM16.1458 4.16667L15.1041 3.125H9.89581L8.85415 4.16667H5.20831V6.25H19.7916V4.16667H16.1458Z" fill="white" fill-opacity="0.5" />
                            </svg>
                        </Button>
                    </Link>
                    <Link>
                    ...
                    <Form.Group className="mb-3">
                        <Form.Select type="text" value='' name='state' onChange=''>
            ...
            <div className="body-project-card d-flex justify-content-around">
                ...
                <p>Tasks on revies:</p>
                <p>Tasks done:</p>
                <AvatarListColaborators colaborators={colaborators} />
            </div>
